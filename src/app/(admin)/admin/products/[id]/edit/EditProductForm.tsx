    ...
    <form action={updateProduct} className="space-y-6">
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 bg-black p-4 rounded-2xl border border-emerald-500/20">
          <div className="w-24 h-24 bg-[#121A16] rounded-xl border border-emerald-500/30 overflow-hidden flex items-center justify-center flex-shrink-0 relative">
            {imageUrl ? (
          ...
          <div className="flex flex-col gap-2 w-full">
            <p className="text-xs text-gray-400">Upload a fresh phone photo to update the studio-framed listing.</p>
            <UploadButton
      ...
      <button 
        type="submit"
        className="w-full bg-emerald-500 text-black font-extrabold uppercase tracking-widest py-4 rounded-xl hover:bg-emerald-400 transition-all flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(16,185,129,0.3)] text-sm"
      >
