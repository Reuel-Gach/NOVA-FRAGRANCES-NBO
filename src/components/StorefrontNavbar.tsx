...
export default function StorefrontNavbar() {
  ...
  return (
    <nav className="border-b border-emerald-500/20 px-4 py-4 sticky top-0 bg-[#090D0B]/90 backdrop-blur-md z-50">
      <div className="max-w-5xl mx-auto flex justify-between items-center">
        
        {/* Brand Logo */}
        <Link href="/" className="text-lg md:text-xl font-bold tracking-widest uppercase text-emerald-400">
          Nova Fragrances
        </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="md:hidden p-2 text-emerald-400 hover:bg-emerald-500/10 rounded-xl transition-colors cursor-pointer"
      ...
      {isOpen && (
        <div className="md:hidden mt-4 pt-4 border-t border-emerald-500/20 flex flex-col gap-2 text-center pb-2">
          <Link 
            ...
            className="py-3 text-xs font-bold uppercase tracking-widest text-gray-300 hover:text-emerald-400 hover:bg-emerald-500/10 rounded-xl transition-colors"
          >
            Masculine
          </Link>
          <Link 
